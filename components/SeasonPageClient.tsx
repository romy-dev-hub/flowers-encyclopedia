// components/SeasonPageClient.tsx
"use client";
...
interface SeasonPageClientProps {
  ...
  seasonFlowers: Flower[];
}

export default function SeasonPageClient({ season, seasonFlowers }: SeasonPageClientProps) {
  const seasonNames = {
    spring: 'Spring',
    summer: 'Summer', 
    fall: 'Fall',
    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-purple-50 pt-20">
      ...
      <div className="max-w-6xl mx-auto px-6 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="ml-1 text-gray-700">{seasonNames[season]}</span>
        </nav>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        >
          <div 
            ...
            style={{ backgroundImage: `url(${seasonData[season].image})` }}
          />
          <div className="absolute inset-0 bg-black/40" />
          <div className="absolute bottom-6 left-6 text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-2">
              {seasonNames[season]} Flowers
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About {seasonNames[season]} Blooms</h2>
            <p className="text-gray-600 mb-4">
              Discover {seasonFlowers.length} beautiful flowers that thrive during {seasonNames[season].toLowerCase()}.
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <ul className="text-gray-600 space-y-2">
                {seasonData[season].tips.map((tip, index) => (
          ...
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              {seasonNames[season]} Flowers ({seasonFlowers.length})
            </h2>
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
            {seasonNames[season]} Gardening Guide
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="prose text-gray-600">
                <p>
                  {seasonNames[season]} offers unique opportunities for gardeners.
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Popular {seasonNames[season]} Flowers</h3>
              <div className="bg-gray-50 p-4 rounded-lg">
                <ul className="text-gray-600 space-y-2">
