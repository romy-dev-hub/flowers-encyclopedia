...
// Modern season card component
const SeasonCard = ({ season, index }: { season: any; index: number }) => {
      ...
      <Link href={`/seasons/${season.name.toLowerCase()}`}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white z-10">
          ...
          <motion.div
            ...
            className="h-0.5 bg-white/50 mb-4"
          />
          ...
          >
            <span className="font-medium">{season.count} flowers</span>
            <motion.div
        ...
        <motion.div 
          ...
          animate={{ borderColor: isHovered ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.3)" }}
